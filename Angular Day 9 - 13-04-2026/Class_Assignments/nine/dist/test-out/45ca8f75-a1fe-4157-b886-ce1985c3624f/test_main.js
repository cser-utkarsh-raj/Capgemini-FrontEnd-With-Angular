...
var MockPlatformLocation = class _MockPlatformLocation {
  ...
  static \u0275fac = function MockPlatformLocation_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MockPlatformLocation)(\u0275\u0275inject(MOCK_PLATFORM_LOCATION_CONFIG, 8));
  };
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MockPlatformLocation, [{
    type: Injectable
  }], () => [{
    type: void 0,
    decorators: [{
...
var FakeNavigationPlatformLocation = class _FakeNavigationPlatformLocation {
  ...
  static \u0275fac = function FakeNavigationPlatformLocation_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FakeNavigationPlatformLocation)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
    token: _FakeNavigationPlatformLocation,
    factory: _FakeNavigationPlatformLocation.\u0275fac
  });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FakeNavigationPlatformLocation, [{
    type: Injectable
  }], () => [], null);
})();
...
var SpyLocation = class _SpyLocation {
  ...
  static \u0275fac = function SpyLocation_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SpyLocation)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
    token: _SpyLocation,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SpyLocation, [{
    type: Injectable
  }], null, null);
})();
...
var MockLocationStrategy = class _MockLocationStrategy extends LocationStrategy {
  ...
  static \u0275fac = function MockLocationStrategy_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _MockLocationStrategy)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MockLocationStrategy, [{
    type: Injectable
  }], () => [], null);
})();
