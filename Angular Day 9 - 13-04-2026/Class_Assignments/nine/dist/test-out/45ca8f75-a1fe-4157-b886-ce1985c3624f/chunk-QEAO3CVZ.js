...
var LocationStrategy, APP_BASE_HREF, PathLocationStrategy, NoTrailingSlashPathLocationStrategy, TrailingSlashPathLocationStrategy, Location;
var init_location_chunk = __esm({
  "node_modules/@angular/common/fesm2022/_location-chunk.mjs"() {
    ...
    NoTrailingSlashPathLocationStrategy = class _NoTrailingSlashPathLocationStrategy extends PathLocationStrategy {
      prepareExternalUrl(internal) {
    ...
    TrailingSlashPathLocationStrategy = class _TrailingSlashPathLocationStrategy extends PathLocationStrategy {
      prepareExternalUrl(internal) {
        const path = extractUrlPath(internal);
        if (!path.endsWith("/")) {
...
//# sourceMappingURL=chunk-QEAO3CVZ.js.map
