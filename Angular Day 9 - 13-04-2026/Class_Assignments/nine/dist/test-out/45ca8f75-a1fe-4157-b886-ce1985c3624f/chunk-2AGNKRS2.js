...
var HttpHeaders, HttpContext, HttpUrlEncodingCodec, STANDARD_ENCODING_REGEX, STANDARD_ENCODING_REPLACEMENTS, HttpParams, CONTENT_TYPE_HEADER, ACCEPT_HEADER, TEXT_CONTENT_TYPE, JSON_CONTENT_TYPE, ACCEPT_HEADER_VALUE, HttpRequest, HttpEventType, HttpResponseBase, HttpHeaderResponse, HttpResponse, HttpErrorResponse, HTTP_STATUS_CODE_OK, HTTP_STATUS_CODE_NO_CONTENT, HttpStatusCode, XSSI_PREFIX$1, FETCH_BACKEND, FetchBackend, FetchFactory, XSSI_PREFIX, HttpXhrBackend, HTTP_INTERCEPTORS, HTTP_INTERCEPTOR_FNS, HTTP_ROOT_INTERCEPTOR_FNS, REQUESTS_CONTRIBUTE_TO_STABILITY, HttpBackend, fetchBackendWarningDisplayed, HttpInterceptorHandler, HttpHandler, HttpClient, nextRequestId, foreignDocument, JSONP_ERR_NO_CALLBACK, JSONP_ERR_WRONG_METHOD, JSONP_ERR_WRONG_RESPONSE_TYPE, JSONP_ERR_HEADERS_NOT_SUPPORTED, JsonpCallbackContext, JsonpClientBackend, JsonpInterceptor, XSRF_ENABLED, XSRF_DEFAULT_COOKIE_NAME, XSRF_COOKIE_NAME, XSRF_DEFAULT_HEADER_NAME, XSRF_HEADER_NAME, HttpXsrfCookieExtractor, HttpXsrfTokenExtractor, HttpXsrfInterceptor, HttpFeatureKind, LEGACY_INTERCEPTOR_FN, HttpClientXsrfModule, HttpClientModule, HttpClientJsonpModule;
...
var HTTP_TRANSFER_CACHE_ORIGIN_MAP, BODY, HEADERS, STATUS, STATUS_TEXT, REQ_URL, RESPONSE_TYPE, CACHE_OPTIONS, ALLOWED_METHODS, httpResource, HttpResourceImpl;
var init_http = __esm({
  "node_modules/@angular/common/fesm2022/http.mjs"() {
    "use strict";
    init_module_chunk();
...
//# sourceMappingURL=chunk-2AGNKRS2.js.map
