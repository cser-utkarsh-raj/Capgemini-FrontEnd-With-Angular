...
var init_app = __esm({
  "src/app/app.ts"() {
    ...
    init_core();
    App = class _App {
      title = signal("nine", ...ngDevMode ? [{ debugName: "title" }] : (
      ...
      static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _App, selectors: [["app-root"]], decls: 3, vars: 0, template: function App_Template(rf, ctx) {
        if (rf & 1) {
          ...
          \u0275\u0275text(1, "Hello, nine");
          \u0275\u0275elementEnd();
          \u0275\u0275element(2, "app-counter");
        }
      }, dependencies: [Counter], encapsulation: 2 });
    };
    (() => {
      (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(App, [{
        type: Component,
        args: [{ selector: "app-root", imports: [RouterOutlet, Counter], template: "<h1>Hello, nine</h1>\n<app-counter></app-counter>" }]
      }], null, null);
    })();
    (() => {
      (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(App, { className: "App", filePath: "app.ts", lineNumber: 11 });
    })();
  }
});
...
var require_app_spec = __commonJS({
  "src/app/app.spec.ts"(exports) {
    ...
    describe("App", () => {
      ...
      it("should render title", () => __async(null, null, function* () {
        const fixture = TestBed.createComponent(App);
        yield fixture.whenStable();
        const compiled = fixture.nativeElement;
        expect(compiled.querySelector("h1")?.textContent).toContain("Hello, nine");
      }));
    });
  }
});
